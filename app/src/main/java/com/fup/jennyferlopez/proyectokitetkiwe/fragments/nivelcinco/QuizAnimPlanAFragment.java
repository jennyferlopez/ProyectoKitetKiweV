 ...
 */
public class QuizAnimPlanAFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_quiz_anim_plan_a, container, false);
...
//        tvPreguntaDos.setTypeface(font);
    ...
    private void irActivity() {
        ...
        trans.replace(R.id.fragmentA, new QuizAnimPlanBFragment());
